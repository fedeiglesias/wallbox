<template>
  <v-dialog v-model="dialogOpen" persistent max-width="600">
    <v-card>
      ...
      <div class="form">
        <v-text-field label="Title" color="#43ba9b" v-model.lazy="book.title">
        </v-text-field>
        ...
        >
          <template v-slot:selection="{ attrs, item, parent }">
            ...
            >
              <v-avatar left>
                <v-img contain class="avatar" :src="item.avatar"> </v-img>
              </v-avatar>
